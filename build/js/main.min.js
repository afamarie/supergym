...
/* harmony import */ var _modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tabs/tabs */ "./js/modules/tabs/tabs.js");
/* harmony import */ var _modules_sliders_sliders__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/sliders/sliders */ "./js/modules/sliders/sliders.js");
/* harmony import */ var _modules_yt_player_yt_player__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/yt-player/yt-player */ "./js/modules/yt-player/yt-player.js");
/* harmony import */ var _modules_yt_player_yt_player__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_yt_player_yt_player__WEBPACK_IMPORTED_MODULE_4__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    var tabs = new _modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_2__["Tabs"]();
    window.tabs = tabs;
  });
});
...
/***/ "./js/modules/sliders/sliders.js":
/*!***************************************!*\
  !*** ./js/modules/sliders/sliders.js ***!
  \***************************************/
/*! exports provided: swiperPeople, swiperReviews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiperPeople", function() { return swiperPeople; });
...
var swiperPeople = new _vendor_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default.a('.swiper--people', {
  loop: true,
...
var swiperReviews = new _vendor_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default.a('.swiper--reviews ', {
  initialSlide: 0,
  slidesPerView: 1,
  slidesPerGroup: 1,
  spaceBetween: 30,
...
/***/ "./js/modules/yt-player/yt-player.js":
/*!*******************************************!*\
  !*** ./js/modules/yt-player/yt-player.js ***!
  \*******************************************/
...
var btn = document.querySelector('.intro__video-btn');
var video = document.querySelector('.intro__video');
var wrapper = document.querySelector('.intro__video-wrapper');
var onClickStartVideo = function onClickStartVideo(evt) {
  evt.preventDefault();
  ...
  setTimeout(function () {
    return wrapper.classList.add('intro__video-wrapper--play');
  }, "1000");
};
...
!function (e, t) {
    ...
    updateProgress: function updateProgress(e) {
      ...
      if (s.loop) {
        var _s13 = t.getSlideIndexByData(0),
          _a5 = t.getSlideIndexByData(t.slides.length - 1),
  ...
  var ce = [function (e) {
    ...
    function u() {
      ...
      if (a = t.params.loop ? t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex : void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
        ...
        if (s.dynamicBullets && (n = x(_i12[0], t.isHorizontal() ? "width" : "height", !0), r.forEach(function (e) {
          ...
          var _e45$classList;
          var _e45 = _i12[a];
          if (_e45 && (_e45$classList = _e45.classList).add.apply(_e45$classList, _toConsumableArray(s.bulletActiveClass.split(" "))), s.dynamicBullets) {
            var _e46 = _i12[_o6],
              _t36 = _i12[_d4];
    ...
    var c = function c() {
      ...
      p = function p() {
        if (l && t.params.hashNavigation.enabled) if (t.params.hashNavigation.replaceState && d.history && d.history.replaceState) d.history.replaceState(null, null, "#".concat(t.slides[t.activeIndex].getAttribute("data-hash")) || false), i("hashSet");else {
